#	Full Documentation, line by line explanation of this code
#	is available in the "Documentation" file in my repo.
#	Check out my blog on this project:
...
def main():
    ...
    while True:
        ...
        print(Fore.BLACK + Back.CYAN + 'DESTINATION:' + Style.RESET_ALL + ' ' + str(dest_mac) + Fore.BLACK + Back.CYAN + '\tSOURCE:' + Style.RESET_ALL +  ' ' + str(src_mac))
        print((Fore.BLACK + Back.CYAN + '\tPROTOCOL:' + Style.RESET_ALL +  ' ' + str(eth_proto) + ' - ' + Fore.WHITE + Back.MAGENTA + str(protocol_ids[eth_proto]) + Style.RESET_ALL))
        if eth_proto == 8:
            (version, header_length, ttl, proto, src, target, data) = ipv4_packet(data)
            print(Fore.BLACK + Back.CYAN + 'IPv4 Packet:' + Style.RESET_ALL, end="")
            print(' Version:[{}] Header Length:[{}] TTL:[{}]'.format(version, header_length, ttl), end="")
            ...
            print(' Protocol:[' + str(proto) + ' - ' + Fore.WHITE + Back.MAGENTA + str(protocol_ids[proto]) + Style.RESET_ALL  + ']' + ' Source:[' + src + ']  Target:[' + str(target) + ']  ' + Fore.WHITE + str(target_name) + Style.RESET_ALL )           
            
            # ICMP
            if proto == 1:
                icmp_type, code, checksum, data = icmp_packet(data)
                print(Fore.WHITE + Back.CYAN + TAB_1 + 'ICMP Packet:' + Style.RESET_ALL, end="")
            ...
            # TCP
                ...
                print(Fore.BLACK + Back.CYAN + TAB_1 + 'TCP Segment:' + Style.RESET_ALL, end="")
                print(' Source Port:[{}]  Destination Port:[{}]'.format(src_port, dest_port), end="")
            ...
            # UDP
                ...
                print(Fore.BLACK + Back.CYAN + 'UDP Segment:' + Style.RESET_ALL, end="")
...
#whois 149.154.170.100 | grep netname | awk '{print $2}'
